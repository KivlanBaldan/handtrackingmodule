...
class HandDetector:
    ...
    def detectGesture(self,HandDataDictionary):
        if not self.fingerUp(HandDataDictionary,thumb) and self.fingerUp(HandDataDictionary,index) and not self.fingerUp(HandDataDictionary,middle) and not self.fingerUp(HandDataDictionary,ring) and not self.fingerUp(HandDataDictionary,pinky):
            return 'one'
        elif self.fingerUp(HandDataDictionary, index) and self.fingerUp(HandDataDictionary, middle) and not self.fingerUp(HandDataDictionary, ring) and not self.fingerUp(HandDataDictionary, pinky) and not self.fingerUp(HandDataDictionary, thumb):
            return 'two'
            ...
            return 'five'
        elif self.fingerUp(HandDataDictionary,thumb) and self.fingerUp(HandDataDictionary,pinky) and not self.fingerUp(HandDataDictionary,middle) and not self.fingerUp(HandDataDictionary,ring) and not self.fingerUp(HandDataDictionary, pinky):
            return "seven"
        elif self.fingerUp(HandDataDictionary,middle) and self.fingerUp(HandDataDictionary,ring) and self.fingerUp(HandDataDictionary, pinky) and not self.fingerUp(HandDataDictionary, thumb) and self.fingerUp(HandDataDictionary, index):
            return "eight"
            ...
            return ' eight'
        elif  self.fingerUp(HandDataDictionary,thumb) and not self.fingerUp(HandDataDictionary,index) and   self.fingerUp(HandDataDictionary,middle) and  not self.fingerUp(HandDataDictionary,ring) and  not self.fingerUp(HandDataDictionary,pinky):
            return ''
            ...
            return 'looser'
        elif self.fingerUp(HandDataDictionary,middle)  and self.fingerUp(HandDataDictionary, ring) and self.fingerUp(HandDataDictionary, pinky) and not self.fingerUp(HandDataDictionary, thumb) and not self.fingerUp(HandDataDictionary, index) and not self.fingerUp(HandDataDictionary, middle):
            return 'OK'
        elif self.fingerUp(HandDataDictionary, index) and self.fingerUp(HandDataDictionary, thumb) and not self.fingerUp(HandDataDictionary, middle) and not self.fingerUp(HandDataDictionary, ring) and not self.fingerUp(HandDataDictionary, pinky):
            return 'seven'
        elif  self.fingerUp(HandDataDictionary,thumb) and  self.fingerUp(HandDataDictionary,index) and   self.fingerUp(HandDataDictionary,middle) and self.fingerUp(HandDataDictionary,ring) and  not self.fingerUp(HandDataDictionary,pinky):
            return ' nine'
...
if __name__ == '__main__':
    ...
    while True:
        ...
        cv2.putText(frame,result,(10,50),cv2.FONT_HERSHEY_PLAIN,4,(255,0,255),2)       
